#!/usr/bin/env bash
# Freeze-then-unfreeze (UNFREEZE_PREREG.md). 5 arms x 8 seeds, one batch.
set -u
REPO=/home/prashr/mapformer
cd /home/prashr
OUT=$REPO/runs/unfreeze; mkdir -p "$OUT/logs"
ARMS=(EMUnf_0 EMUnf_5 EMUnf_30 EMUnf_100 EMUnf_0_e8)
MAXPG=3
