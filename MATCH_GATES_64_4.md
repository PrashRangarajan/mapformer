...
Scored only at cells visited during explore AND non-blank. size=64, n_obs=4, so chance = 1/4 = 0.2500.

| T_explore | T_query | chance | marginal | n-gram o1 | o3 | o5 | never-moved | answerable rate | n |
|---|---|---|---|---|---|---|---|---|---|
| 512 | 256 | 0.2500 | 0.2546 | 0.2479 | 0.2484 | 0.2428 | 0.1515 | 0.041 | 6246 |
