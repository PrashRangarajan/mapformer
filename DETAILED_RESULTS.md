...
This document preserves the full experiment-by-experiment narrative,
session-by-session findings, ablation details, and historical framings.
For a tightened paper-style overview, see [README.md](README.md).

For the latest comprehensive session summary, see
[RESULTS_SUMMARY_2026-05-10.md](RESULTS_SUMMARY_2026-05-10.md).
For individual per-experiment result markdowns, see the `*_RESULTS.md`
and `*_DIAGNOSTIC.md` files in the repo root.

---

# MapFormer + Parallel Invariant EKF: Cognitive Maps with Calibrated State Correction (full record)
