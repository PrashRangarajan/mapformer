...
Seeds actually found per variant: MapEM-Flat=[0, 1, 2], VanillaEM_Fixed=[0, 1, 2], MapWM-Flat=[0, 1, 2], MapWM-Hier=[0, 1, 2], Plain-Flat=[0, 1, 2]
...
| VanillaEM_Fixed | 0.158 ± 0.056 (n=3) | 0.078 ± 0.038 (n=3) | 0.032 ± 0.017 (n=3) | 0.014 ± 0.008 (n=3) |
...
| VanillaEM_Fixed | 0.789 ± 0.080 (n=3) | 0.710 ± 0.059 (n=3) | 0.623 ± 0.040 (n=3) | 0.561 ± 0.021 (n=3) |
...
| VanillaEM_Fixed | 1.684 ± 0.042 (n=3) | 1.837 ± 0.054 (n=3) | 1.935 ± 0.049 (n=3) | 1.977 ± 0.040 (n=3) |
